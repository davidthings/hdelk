...
var hdelk = (function(){
    ...
    var node_highlight_fill_color = ['#FFF', '#DDD', '#4bF','#F88', '#FE6','#7e0','#9FE','#900','#C3F'];
    ...
    var node_highlight_name_text_color = [ '#DDD', '#222', '#46C', '#922', '#A90', '#350','#FCC','#F09','#F63'];
    ...
    var port_highlight_fill_color = [ '#DDD', '#444', '#06d', '#C00', '#980', '#590' ,'#9FC','#906','#C39'];
    var port_spacing = 4;
    ...
    var edge_label_highlight_fill_color = [ '#DDD', '#222', '#46C', '#922', '#A90', '#350' ,'#FCC','#F09','#F63'];

    var edge_width = 1;
    var edge_color = '#888';
    var edge_highlight_color = [ '#DDD', '#444', '#06d', '#C00', '#980', '#590','#9FC' ,'#906','#C39'];
    var edge_highlight_width = 2;
    var edge_bus_width = 6;
    var edge_bus_color = '#AAA';
    var edge_bus_highlight_color = [ '#DDD', '#444', '#06d', '#C00', '#980', '#590' ,'#9FC','#906','#C39'];
